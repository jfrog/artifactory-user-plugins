...
A Maven plugin to create a global pom.xml for all artifacts of parent build and
child builds.
...
Add the following section to pom.xml of your project:
```xml
<plugins>
    <plugin>
...
This will call the MavenDep endpoint to get a list of GAVs, and create a
new-pom.xml.
