...
jobs {
    ...
    copyModifiedPoms(interval: 300000, delay: 300000) {
        ...
        def binStore = ctx.beanForType(BinaryService.class)
...
def findAndSaveAll(JdbcHelper jdbcHelper, InternalRepositoryService repoService, BinaryService binStore, DbService dbService) {
    ...
    while (res.next()) {
        ...
        dbService.invokeInTransaction('saveModifiedPomsTransaction',
            { ->
